            ...
            switch (type) {
                case 'potion':
                    if (global.DATABASE.data.users[m.sender].potion >= count * 1) {
                        ...
                        conn.reply(m.chat, `Success sell ${count} Potion for ${Spotion * count} money`.trim(), m) 
                ...
                case 'common':
                    if (global.DATABASE.data.users[m.sender].common >= count * 1) {
                        ...
                        conn.reply(m.chat, `Success sells ${count} Common Crate with price ${Scommon * count} money`.trim(), m) 
                ...
                case 'uncommon':
                    if (global.DATABASE.data.users[m.sender].uncommon >= count * 1) {
                        ...
                        conn.reply(m.chat, `Succes sells ${count} Uncommon Crate dengan harga ${Suncommon * count} money`.trim(), m)
                ...
                case 'sampah':
                    if (global.DATABASE.data.users[m.sender].sampah >= count * 1) {
                        ...
                        conn.reply(m.chat, `Success sells ${count} junk, and you get ${Junk * count} money`.trim(), m)
                ...
                case 'diamond':
                    if (global.DATABASE.data.users[m.sender].diamond >= count * 1) {
                        ...
                        conn.reply(m.chat, `Successfully sell ${coin} Diamond, and you get ${Diamond * count} money`, m)
